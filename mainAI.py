...
# Adapted by FRC Team 1747 for use with Jetson Nano 2gb, and communicating with RoboRio.
"""
...
def run(weights=ROOT / 'yolov5s.pt',  # model.pt path(s)
    ...
    # Dataloader
    if webcam:
        view_img = False #check_imshow() DISABLE VIEW WINDOW
...
def mainYolo(opt):
    ...
    # Turn on text_save
    opt.save_txt = True
    # Set data source to webcam
    opt.source = 0
    # Hide all video annotations
